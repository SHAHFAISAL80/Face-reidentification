...
def parse_args():
    ...
    parser.add_argument(
        "--det-weight",
        type=str,
        default=r"C:\Users\x\Videos\face-reidentification-main\face-reidentification-main\weights\det_10g.onnx",
        help="Path to detection model"
    )
    parser.add_argument(
        "--rec-weight",
        type=str,
        default=r"C:\Users\x\Videos\face-reidentification-main\face-reidentification-main\weights\w600k_r50.onnx",
    ...
    parser.add_argument(
        "--source",
        type=str,
        default=r"C:\Users\x\Videos\face-reidentification-main\face-reidentification-main\assets\in_video.mp4",
